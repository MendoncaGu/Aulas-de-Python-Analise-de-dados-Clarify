...
def grafico():
    ...
    # se a nota esta vazia cai nesse return
    if base.empty:
        return render_tamplate_string("<h2> Sem dados de notas para plotar</h2>")
...
def filmes_diretor():
    ...
    fig = px.bar(
        ...
        x = "Diretor",
        y = "Quantidade",
        title = "Quantidade de filmes por Diretor",
