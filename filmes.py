...
for pagina in range(1, paginaLimite +1):
    ...
    print(f"Coletando dados da pagnia {pagina}. Aguarde... \n URL: {url}")
    resposta = requests.get(url, headers=headers)

    if resposta.status_code != 200:
        print(f"Erro ao carregar a pagina {pagina}. Codigo{resposta.status_code}")
    ...
    for card in cards:
        try:
            ...
            # dica: a tagc "span" e o nome da classe é date
...
print("\nObrigado por usar o sistema Bot cinéfalo!")
